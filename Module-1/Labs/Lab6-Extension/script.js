...
function getCompanyStartYear(person_name)
{
    ...
    for (let company of companies)
    {
        ...
        {
            console.log(person_name+" works at "+company.name+" which was founded in "+company.start);
...
//DONE: Create functions to remove a person; to remove a company
